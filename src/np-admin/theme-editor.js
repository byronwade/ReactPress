			...
			<div id="wpbody-content">
					...
					>
						...
						<div id="contextual-help-columns">
							...
							<div className="contextual-help-tabs-wrap">
								...
								>
									<p>
										You can use the theme file editor to
										edit the individual CSS and PHP files
										which make up your theme.
									</p>
									<p>
										Begin by choosing a theme to edit from
										the dropdown menu and clicking the
										Select button. A list then appears of
										the theme’s template files. Clicking
										once on any file name causes the file to
										appear in the large Editor box.
									</p>
									<p>
										For PHP files, you can use the
										documentation dropdown to select from
										functions recognized in that file. Look
										Up takes you to a web page with
										reference material about that particular
										function.
									</p>
									...
									<p>
										After typing in your edits, click Update
										File.
									</p>
									<p>
										<strong>Advice:</strong> Think very
										carefully about your site crashing if
										you are live-editing the theme currently
										in use.
									</p>
									<p>
										Upgrading to a newer version of the same
										theme will override changes made here.
										To avoid this, consider creating a{" "}
										<a href="/">child theme</a> instead.
									</p>{" "}
								</div>
							</div>
						</div>
				...
				<div className="wrap">
					...
					<div id="message" className="notice-info notice">
						...
						<p>
							There is no need to change your CSS here — you can
							edit and live preview CSS changes in the{" "}
							<a href="/">built-in CSS editor</a>.{" "}
						</p>
					</div>
					<div className="fileedit-sub">
						<div className="alignleft">
							<h2>
								Wade's Headless WordPress: Stylesheet{" "}
								<span>(style.css)</span>
							</h2>
						</div>
					...
					>
						<input
							...
							id="nonce"
							name="nonce"
							defaultValue="93845f1604"
						/>
						<input
							type="hidden"
							name="_wp_http_referer"
							defaultValue="/wp-admin/theme-editor.php"
						/>{" "}
						<div>
							<label
								htmlFor="newcontent"
							...
							<div className="CodeMirror cm-s-default CodeMirror-wrap">
								<div
									...
									cm-not-content="true"
									style={{ width: 18, pointerEvents: "none" }}
								>
