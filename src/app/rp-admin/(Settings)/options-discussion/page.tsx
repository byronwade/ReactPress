									...
									<td>
										<fieldset>
											...
											<label htmlFor="default_pingback_flag">
												<input name="default_pingback_flag" type="checkbox" id="default_pingback_flag" defaultValue={1} defaultChecked="checked" />
												Attempt to notify any blogs linked to from the post
											</label>
											<br />
											<label htmlFor="default_ping_status">
												<input name="default_ping_status" type="checkbox" id="default_ping_status" defaultValue="open" defaultChecked="checked" />
												Allow link notifications from other blogs (pingbacks and trackbacks) on new posts
											</label>
											<br />
											<label htmlFor="default_comment_status">
												<input name="default_comment_status" type="checkbox" id="default_comment_status" defaultValue="open" defaultChecked="checked" />
									...
									<td>
										<fieldset>
											...
											<label htmlFor="require_name_email">
												<input type="checkbox" name="require_name_email" id="require_name_email" defaultValue={1} defaultChecked="checked" /> Comment author must fill out name and email
											</label>
											<br />
											...
											<label htmlFor="show_comments_cookies_opt_in">
												<input name="show_comments_cookies_opt_in" type="checkbox" id="show_comments_cookies_opt_in" defaultValue={1} defaultChecked="checked" />
												Show comments cookies opt-in checkbox, allowing comment author cookies to be set
											</label>
											<br />
											<label htmlFor="thread_comments">
												<input name="thread_comments" type="checkbox" id="thread_comments" defaultValue={1} defaultChecked="checked" />
									...
									<td>
										<fieldset>
											...
											<label htmlFor="comments_notify">
												<input name="comments_notify" type="checkbox" id="comments_notify" defaultValue={1} defaultChecked="checked" />
												Anyone posts a comment{" "}
											</label>
											<br />
											<label htmlFor="moderation_notify">
												<input name="moderation_notify" type="checkbox" id="moderation_notify" defaultValue={1} defaultChecked="checked" />A comment is held for moderation{" "}
											</label>
										</fieldset>
									</td>
								</tr>
									...
									<td>
										<fieldset>
											...
											<label htmlFor="comment_previously_approved">
												<input type="checkbox" name="comment_previously_approved" id="comment_previously_approved" defaultValue={1} defaultChecked="checked" /> Comment author must have a previously approved comment
											</label>
										</fieldset>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<label htmlFor="show_avatars">
											<input type="checkbox" id="show_avatars" name="show_avatars" defaultValue={1} defaultChecked="checked" />
											Show Avatars{" "}
										</label>
									</td>
								</tr>
								<tr className="avatar-settings">
									...
									<td>
										<fieldset>
											...
											<label>
												<input type="radio" name="avatar_rating" defaultValue="G" defaultChecked="checked" /> G — Suitable for all audiences
											</label>
											<br />
											<label>
								...
								<tr className="avatar-settings">
									...
									<td className="defaultavatarpicker">
										<fieldset>
											...
											<label>
												<input type="radio" name="avatar_default" id="avatar_mystery" defaultValue="mystery" defaultChecked="checked" /> <img alt="" src="https://secure.gravatar.com/avatar/08c21cf8ce49f5d7d5c1d8e49d4649f8?s=32&d=mm&f=y&r=g" srcSet="https://secure.gravatar.com/avatar/08c21cf8ce49f5d7d5c1d8e49d4649f8?s=64&d=mm&f=y&r=g 2x" className="avatar avatar-32 photo avatar-default" height={32} width={32} loading="lazy" decoding="async" /> Mystery Person
											</label>
											<br />
											<label>
